...
public class Soul_Extractor_Recipe implements IExtractor_Recipe {
    ...
    public Soul_Extractor_Recipe(ResourceLocation recipeId, ItemStack output, Ingredient ingredient0, Ingredient ingredient1, int time) {
    ...
    public IRecipeSerializer<?> getSerializer() {
        return ModRecipeTypes.EXTRACTOR_SERIALIZER.get();
    }

    public static class Soul_Extractor_RecipeType implements IRecipeType<Soul_Extractor_Recipe> {
        @Override
        public String toString() {
            return Soul_Extractor_Recipe.TYPE_ID.toString();
        }
    }
    ...
    public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>>
            implements IRecipeSerializer<Soul_Extractor_Recipe> {
        ...
        public Soul_Extractor_Recipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new Soul_Extractor_Recipe(recipeId, output, ingredient0, ingredient1, time);
        }
        @Nullable
        @Override
        public Soul_Extractor_Recipe fromNetwork(ResourceLocation recipeId, PacketBuffer buffer) {
        ...
        @Override
        public void toNetwork(PacketBuffer buffer, Soul_Extractor_Recipe recipe) {
