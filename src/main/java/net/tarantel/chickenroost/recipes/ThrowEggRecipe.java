...
public class ThrowEggRecipe implements IThrowEgg_Recipe {
    ...
    public ThrowEggRecipe(ResourceLocation recipeId, ItemStack output, Ingredient ingredient0, Ingredient ingredient1, int time) {
    ...
    public IRecipeSerializer<?> getSerializer() {
        return ModRecipeTypes.THROWEGG_SERIALIZER.get();
    }

    public static class ThrowEggRecipeType implements IRecipeType<ThrowEggRecipe> {
        @Override
        public String toString() {
            return ThrowEggRecipe.TYPE_ID.toString();
        }
    }
    ...
    public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>>
            implements IRecipeSerializer<ThrowEggRecipe> {
        ...
        public ThrowEggRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new ThrowEggRecipe(recipeId, output, ingredient0, ingredient1, time);
        }
        @Nullable
        @Override
        public ThrowEggRecipe fromNetwork(ResourceLocation recipeId, PacketBuffer buffer) {
        ...
        @Override
        public void toNetwork(PacketBuffer buffer, ThrowEggRecipe recipe) {
