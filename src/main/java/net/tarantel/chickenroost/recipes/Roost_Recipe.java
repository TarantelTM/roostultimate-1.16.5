...
public class Roost_Recipe implements IRoost_Recipe {
    ...
    public IRecipeSerializer<?> getSerializer() {
        return ModRecipeTypes.ROOST_SERIALIZER.get();
    }

    public static class Roost_RecipeType implements IRecipeType<Roost_Recipe> {
        @Override
        public String toString() {
            return Roost_Recipe.TYPE_ID.toString();
        }
    }
    ...
    public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>>
            implements IRecipeSerializer<Roost_Recipe> {
        ...
        @Nullable
        @Override
        public Roost_Recipe fromNetwork(ResourceLocation recipeId, PacketBuffer buffer) {
        ...
        @Override
        public void toNetwork(PacketBuffer buffer, Roost_Recipe recipe) {
