...
public class Roost_Screen extends ContainerScreen<Roost_Container> {
    ...
    public Roost_Screen(Roost_Container screenContainer, PlayerInventory inv, ITextComponent titleIn) {
