...
public class Extractor_Container extends Container {
    ...
    public Extractor_Container(int windowId, World world, BlockPos pos,
        ...
        if (tileEntity instanceof Extractor_Tile) {
            this.data = ((Extractor_Tile) tileEntity).getDataAccess();
        } else {
    ...
    public boolean stillValid(PlayerEntity playerIn) {
        return stillValid(IWorldPosCallable.create(tileEntity.getLevel(), tileEntity.getBlockPos()),
                playerIn, ModBlocks.SOUL_EXTRACTOR.get());
    }
