...
public class Roost_Container extends Container {
    ...
    public Roost_Container(int windowId, World world, BlockPos pos,
        ...
        if (tileEntity instanceof Roost_Tile) {
            this.data = ((Roost_Tile) tileEntity).getDataAccess();
        } else {
