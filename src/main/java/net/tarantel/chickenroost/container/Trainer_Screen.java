...
public class Trainer_Screen extends ContainerScreen<Trainer_Container> {
    ...
    public Trainer_Screen(Trainer_Container screenContainer, PlayerInventory inv, ITextComponent titleIn) {
