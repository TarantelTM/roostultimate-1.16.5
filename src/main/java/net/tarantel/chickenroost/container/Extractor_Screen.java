...
public class Extractor_Screen extends ContainerScreen<Extractor_Container> {
    private final ResourceLocation GUI = new ResourceLocation(ChickenRoostMod.MODID,
            "textures/screens/newsoulextractorgui.png");
    ...
    public Extractor_Screen(Extractor_Container screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    protected void renderBg(MatrixStack matrixStack, float partialTicks, int x, int y) {
        ...
        //this.blit(matrixStack, this.leftPos + 59, this.topPos + 41, 0, 0, 40, 10, 40, 10);

        // Render the arrow (scaled based on progress)
        this.minecraft.getTextureManager().bind(ARROW);

        this.blit(matrixStack, this.leftPos + 59, this.topPos + 41, 0, 0, menu.getScaledProgress(), 10, 40, 10);
