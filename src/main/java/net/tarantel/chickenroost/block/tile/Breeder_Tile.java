...
public class Breeder_Tile extends TileEntity implements ITickableTileEntity {
    ...
    public Breeder_Tile(TileEntityType<?> tileEntityTypeIn) {
    ...
    protected final IIntArray dataAccess = new IIntArray() {
        ...
        public void set(int pIndex, int pValue) {
            switch(pIndex) {
                case 0:
                    Breeder_Tile.this.progress = pValue;
                    break;
                case 1:
                    Breeder_Tile.this.maxProgress = pValue;
                    break;
            }
    ...
    public void craft() {
        ...
        Optional<Breeder_Recipe> recipe = level.getRecipeManager()
                .getRecipeFor(ModRecipeTypes.BREEDER_RECIPE, inv, level);
    ...
    private static void craftItem(Breeder_Tile pEntity) {
        ...
        List<Breeder_Recipe> recipe = pEntity.getLevel().getRecipeManager()
                .getRecipesFor(ModRecipeTypes.BREEDER_RECIPE, inventory, pEntity.getLevel());
        if (level != null) {
    ...
    private static boolean hasRecipe(Breeder_Tile entity) {
        ...
        if (level != null) {
            ...
            recipe = recipeManager.getRecipeFor(ModRecipeTypes.BREEDER_RECIPE, inventory, level);
