...
public class AnimatedChicken_4 extends ChickenItemBase implements IAnimatable, ISyncable {
    ...
    public void registerControllers(AnimationData data) {
        AnimationController<AnimatedChicken_4> controller = new AnimationController<AnimatedChicken_4>(this, CONTROLLER_NAME, 20, this::predicate);
    ...
    public void appendHoverText(ItemStack itemstack, @Nullable World world, List<ITextComponent> list, ITooltipFlag flag) {
        ...
        list.add(ITextComponent.nullToEmpty("\u00A71" + "Tier: " + "\u00A79" + "4"));
        list.add(ITextComponent.nullToEmpty((("\u00A7e") + "Level: " + "\u00A79" + ((itemstack).getOrCreateTag().getInt("roost_lvl")) + "/" + (((int) Config.maxlevel_tier_4.get())))));
        list.add(ITextComponent.nullToEmpty((("\u00A7a") + "XP: " + "\u00A79" + ((itemstack).getOrCreateTag().getInt("roost_xp")) + "/" + (((int) Config.xp_tier_4.get())))));
