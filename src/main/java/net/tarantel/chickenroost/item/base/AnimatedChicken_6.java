...
public class AnimatedChicken_6 extends ChickenItemBase implements IAnimatable, ISyncable {
    ...
    public void registerControllers(AnimationData data) {
        AnimationController<AnimatedChicken_6> controller = new AnimationController<AnimatedChicken_6>(this, CONTROLLER_NAME, 20, this::predicate);
